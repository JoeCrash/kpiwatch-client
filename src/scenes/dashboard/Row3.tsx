...
const Row3 = () => {
  ...
  const transactionColumns = [
    ...
    { field: "productIds", headerName: "Count", flex: 0.67, renderCell: (params: GridCellParams) => (params.value as Array<string>).length },
  ];
  ...
  return (
    <>
      ...
      <DashboardBox gridArea="i">
        ...
        <FlexBetween mt="0.5rem" mb="0.3rem" gap="0.25rem" p="0 0.5rem" textAlign="center">
      ...
      <DashboardBox bgcolor="#fff" gridArea="j">
        ...
        <Typography margin="0 1rem" variant="h6">
          Words to compel you to cheer or freak out depending on the numbers.
        </Typography>
      </DashboardBox>
    </>
  )
